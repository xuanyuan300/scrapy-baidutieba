...
class MyImagesPipeline(MediaPipeline):
    ...
    def __init__(self, store_uri, download_func=None):
        ...
        super(MyImagesPipeline, self).__init__(download_func=download_func)
    ...
    def media_downloaded(self, response, request, info):
        ...
        try:
            key = self.image_key(request.meta.get('id'),request.url)
